...
const OldSchoolPage = () => {
  const styleData = {
    ...
    metaTitle: "Tatuaggio Old school a Torino - GranBabar",
    metaDescription:
      "Se ami lo stile senza tempo dei tatuaggi old school, sei nel posto giusto. Gran Babar realizza old school tattoo a Torino, mantenendo viva la tradizione con linee audaci, colori pieni e simboli iconici.",
    h1: "Old School Tattoo a Torino",
    intro:
      "Se ami lo stile senza tempo dei tatuaggi old school, sei nel posto giusto. Gran Babar realizza old school tattoo a Torino, mantenendo viva la tradizione con linee audaci, colori pieni e simboli iconici. Ogni tatuaggio è studiato per resistere nel tempo, unendo la forza della tradizione alla personalizzazione moderna.",
    about: [
      "L'old school tattoo nasce nei primi decenni del '900, quando marinai, avventurieri e ribelli lo usavano per raccontare la loro storia. Grazie a tatuatori leggendari come Sailor Jerry, questo stile ha mantenuto la sua forza espressiva fino ai giorni nostri. Linee spesse, colori accesi e soggetti simbolici – ancore, rondini, pugnali e pin-up – hanno reso questo genere inconfondibile. Gran Babar porta avanti questa tradizione nel suo studio a Torino, reinterpretandola con passione e cura per i dettagli.",
      "Il segreto di un old school tattoo a Torino di successo risiede nella precisione tecnica e nell'attenzione ai dettagli. Gran Babar utilizza metodi tradizionali che garantiscono inchiostri duraturi e disegni nitidi. Questo stile si distingue per l'uso di linee spesse, contorni ben definiti e colori solidi, che resistono al tempo e mantengono la loro intensità anno dopo anno.",
      "Gran Babar ha fatto dell'old school tattoo un vero e proprio linguaggio artistico. La sua esperienza e la sua passione per il disegno lo portano a reinterpretare i classici in chiave moderna, senza mai tradirne l'essenza. Ogni tatuaggio è il risultato di un processo creativo condiviso con il cliente, per trasformare un'idea in un'opera d'arte su pelle."
    ],
    features: [
    ...
    process: [
      "Consulenza iniziale: discutiamo il soggetto e il significato che vuoi dare al tatuaggio. Gran Babar accompagna i suoi clienti nella scelta, curando ogni dettaglio per rendere il tatuaggio un pezzo unico.",
