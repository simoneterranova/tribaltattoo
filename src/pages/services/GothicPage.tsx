...
const GothicPage = () => {
  const styleData = {
    ...
    metaTitle: "Tatuaggio Gotico a Moncalieri (Torino) | Tribal Tattoo | Stile Dark ed Elegante",
    metaDescription:
      "Tatuaggi gotici a Moncalieri (Torino). Teschi, rose nere, architetture gotiche, blackletter. Studio Tribal Tattoo. Atmosfera dark ed elegante. Prenota consulenza.",
    ...
    about: [
      ...
      "Tribal Tattoo interpreta lo stile gotico con sensibilità artistica, creando tatuaggi che bilanciano l'oscurità con l'eleganza, il macabro con il bello, risultando in opere che celebrano l'estetica gotica in tutte le sue sfumature."
    ],
    features: [
    ...
    process: [
      ...
      "Design elaborato: Claudio Ciliberti lavora sui dettagli ornamentali che rendono unico ogni tatuaggio gotico.",
    ...
    faqs: [
      ...
      { question: "Quali tecniche vengono utilizzate per realizzare un tatuaggio gotico?", answer: "TRIBAL TATTOO utilizza una combinazione di tecniche tradizionali e moderne, impiegando strumenti di precisione e inchiostri di alta qualità per ottenere tratti definiti e sfumature armoniose, esaltando il carattere simbolico del design." }
    ]
  };
