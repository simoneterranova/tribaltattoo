...
const DotworkPage = () => {
  const styleData = {
    ...
    metaTitle: "Tatuaggio Dotwork a Moncalieri (Torino) | Tribal Tattoo Studio | Tecnica Puntinata",
    metaDescription:
      "Tatuaggi dotwork a Moncalieri (Torino). Tecnica raffinata a punti per ombreggiature e texture uniche. Studio Tribal Tattoo, maestria e precisione. Prenota consulenza.",
    h1: "Tatuaggi Dotwork a Moncalieri (Torino)",
    intro:
    ...
    about: [
      ...
      "Tribal Tattoo, nel suo studio a Moncalieri (Torino), realizza tatuaggi dotwork con maestria e attenzione ai dettagli, trasformando la pelle in un'opera d'arte fatta di pazienza, precisione e armonia visiva."
    ],
    features: [
    ...
    process: [
      "Consulenza iniziale: Claudio Ciliberti ascolta le tue idee e ti mostra esempi di dotwork per aiutarti a visualizzare il risultato finale.",
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: "Il processo si basa su strumenti di precisione e l'uso di inchiostri di alta qualità. TRIBAL TATTOO unisce metodi tradizionali e innovativi, concentrandosi sulla corretta disposizione dei puntini per ottenere disegni nitidi e gradazioni armoniose."
      },
      {
      ...
      {
        question: "Perché scegliere TRIBAL TATTOO per il tuo tatuaggio dotwork a Moncalieri (Torino)?",
        answer: "Scegliere TRIBAL TATTOO significa affidarsi a un'esperienza di oltre 30 anni dal 1994, a una passione per l'arte e a un approccio personalizzato che trasforma ogni tatuaggio in un'opera unica. La professionalità, l'attenzione al dettaglio e l'innovazione tecnologica fanno di ogni consultazione un percorso di scoperta e creazione artistica."
      }
    ]
  };
