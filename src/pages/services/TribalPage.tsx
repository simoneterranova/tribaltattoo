...
const TribalPage = () => {
  const styleData = {
    ...
    metaTitle: "Tatuaggio Tribale a Torino | Gran Babar | Tradizione Ancestrale",
    metaDescription:
      "Tatuaggi tribali a Torino. Stile polinesiano, maori, celtico. Simboli ancestrali e motivi geometrici. Studio Gran Babar. Prenota consulenza gratuita.",
    h1: "Tatuaggio Tribale a Torino",
    intro:
    ...
    about: [
      ...
      "Ogni elemento in un tatuaggio tribale ha un significato preciso: denti di squalo rappresentano protezione, onde simboleggiano l'oceano e il viaggio, spine di pesce indicano adattabilità. Gran Babar studia questi simboli con rispetto per le tradizioni culturali da cui provengono.",
    ...
    gallery: [
      { src: "/images/styles/tatuaggio-tribale-a-torino/tribale-tattoo-1.jpg", alt: "Tatuaggio Tribale polinesiano - Gran Babar Torino" }
    ],
    relatedStyles: [
